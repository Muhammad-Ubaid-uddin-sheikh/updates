...
const NOTIFICATION = 'https://kickers-backend-5e360941484b.herokuapp.com/api/player/logIn';
const Sigup = ({ navigation }) => {
    ...
    const handlePrivacyPolicyPress = () => {
        // Open privacy policy page URL
        Linking.openURL('https://kickers.mx/terms-&-Conditions');
      };
    let payload = {
        username:Username,
  ...
  <TouchableOpacity onPress={() => Linking.openURL('https://kickers.mx/privacy-policy')}>
    <Text style={[styles.privacyPolicyText,{color: '#408639'}]}>política de privacidad</Text>
            ...
            <View style={styles.SinupText}>
                ...
                <TouchableOpacity style={styles.buttonGoole} onPress={signIn}>
                ...
                {/* <TouchableOpacity onPress={getCurrentUserInfo} style={styles.buttonGoole}>
