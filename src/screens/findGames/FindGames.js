...
//                <MatchPlayerDetails Address={item.address} Link={()=> navigation.navigate('ParticularTeamJoinScreen',{item:item})} LookingFor={item.lookingFor} matchType={item.matchType}  MatchDate={item.date} duration={item.duration} />
