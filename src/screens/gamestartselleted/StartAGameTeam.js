  ...
  console.log(timingRange)
    return (
      ...
      <View style={styles.MainContainer}>
            ...
            <View style={{ backgroundColor: 'rgba(64, 134, 57, 0.05)', paddingTop: 5, marginTop: -1, paddingBottom: 13, borderWidth: 1, borderColor: 'rgba(0, 0, 0, 0.25)', borderTopWidth: 0, borderWidth: 0.25, borderBottomLeftRadius: 12, borderBottomRightRadius: 12 }}>
              {data?.length === 0 ? (
               ...
               <Checking key={index} focus={false} labelName='Hora de inicio' value={timing}  />
                ...
                <Checking  focus={false} labelName='Buscando'  value={'Team'}/>
                ...
                <Checking   Type='number' focus={true} labelName='Maximo de jugadores' onChangeText={(text) => setnumberofPlayer(text)} value={'10'}/>
        ...
        placeholder="escribe una nota para otro equipo
        "
      />
      ...
      >
        <View style={styles.modalBackground}>
          <View style={styles.modalContent}>
            ...
            <Image source={require('../../assets/CheckIconImg.png')} style={{width:'100%',height:100,objectFit:'contain',marginTop:12}} />
            </View>
